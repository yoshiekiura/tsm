...
$upload_dir = '/assets/userfiles/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../assets/userfiles/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../assets/userfiles.thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$ext_file = array('doc', 'docx', 'pdf', 'xls', 'xlsx', 'csv', 'fla', 'ppt', 'pptx'); //Files
