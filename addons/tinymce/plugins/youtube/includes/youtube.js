				...
				if(data.feed.entry) {
					...
					for (i = 0; i < data.feed.entry.length; i++) {
						...
						if(data.feed.entry[i].yt$statistics != undefined) {
							...
							row += "<span style='font-size:12px; color:#999999;'>by " + data.feed.entry[i].author[0].name.$t + "</span><br />";
							//row += "<span style='font-size:12px' color:#999999>" + data.feed.entry[i].yt$statistics.viewCount + " views" + "<span><br />";
							row += "<span style='font-size:12px; color:#777777;'>" + convertSeconds(data.feed.entry[i].media$group.yt$duration.seconds) + "<span><br />";
							row += "</td>";
