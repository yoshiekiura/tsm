...
| Default value : (none).
*/
$config['sig_image_path'] = _doc_root . _dir_captcha . 'captcha.png';
...
*/
$config['sig_image_width']  = 180;
$config['sig_image_height'] = 60;
...
*/
$config['sig_image_background_color_R'] = 0;
$config['sig_image_background_color_G'] = 0;
$config['sig_image_background_color_B'] = 0;
...
| Default values : 0. 
*/
$config['sig_image_number_of_polygonal_jamming_lines'] = 21;
...
*/
$config['sig_image_jamming_lines_color_R'] = 136;
$config['sig_image_jamming_lines_color_G'] = 136;
$config['sig_image_jamming_lines_color_B'] = 136;
...
| Default values : 0,0,0. 
*/
$config['sig_text_color_R'] = 204;
$config['sig_text_color_G'] = 204;
$config['sig_text_color_B'] = 204;
...
| Default values : 0. 
*/
$config['sig_text_shadow_distance'] = 1;  
...
*/
$config['sig_text_shadow_color_R'] = 255;
$config['sig_text_shadow_color_G'] = 0;
$config['sig_text_shadow_color_B'] = 0;
...
| Default values : 0. 
*/
$config['sig_text_start_position'] = 18;
...
| Default values : 4. 
*/
$config['sig_text_number_of_characters'] = '5';
...
*/
$config['sig_text_font'] = _dir_fonts . 'arial.ttf';
...
| Default values : 'none). 
*/
$config['sig_text_font_size_min'] = 16;  
$config['sig_text_font_size_max'] = 22;  
...
| Default values : 0,0. 
*/
$config['sig_text_character_angle_min'] = -30;  
$config['sig_text_character_angle_max'] = +30;  
