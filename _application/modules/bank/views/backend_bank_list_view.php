...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Logo', name: 'bank_logo', width: 120, sortable: false, align: 'center', datasource: false },
            { display: 'Nama Bank', name: 'bank_name', width: 400, sortable: true, align: 'left' },
            { display: 'Aktif', name: 'bank_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Nama Bank', name: 'bank_name', type: 'text', isdefault: true },
            { display: 'Status Aktif', name: 'bank_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "bank_id",
        sortorder: "desc",
        usepager: true,
