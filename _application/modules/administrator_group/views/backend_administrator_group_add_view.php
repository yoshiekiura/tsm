<h2>Tambah Data Grup Administrator</h2>
<?php
...
<div class="box">
    <div class="box-title">
        <div class="caption"><i class="icon-reorder"></i>Form Tambah Data Grup Administrator</div>
    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_dropdown('type', $type_options, (isset($this->arr_flashdata['input_type'])) ? $this->arr_flashdata['input_type'] : '', 'id="type" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                <?php
