...
/**
 * Description of frontend_partner_widget
 *
 * @author el-fatih
 */
class frontend_partner_widget extends Widget {
...
//
//        $data['widget_title'] = '';
        $data['query'] = $this->widget_model->get_partner();

        $this->render($widget_themes . 'partner_widget_view', $data);
    }
