            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        ...
                        <div class="radio"><label><?php echo form_radio(array('name' => 'type', 'value' => 'custom', 'checked' => $custom_checked, 'onclick' => 'this.form.modules_link.disabled=true; this.form.page_link.disabled=true; this.form.link.removeAttribute(\'readonly\', false); this.form.link.value=\'\'; this.form.link.focus();')); ?>&nbsp;Custom Link</label></div><br />
