...
<div class="box">
    <div class="box-title">
        <div class="caption"><i class="icon-reorder"></i>Form Tambah Promo</div>
    </div>
    <div class="box-body form">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        <?php echo form_textarea_tinymce('promo_content', (isset($this->arr_flashdata['input_promo_content'])) ? $this->arr_flashdata['input_promo_content'] : '', 'PageGenerator'); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        <?php echo form_input('promo_price', (isset($this->arr_flashdata['input_promo_price'])) ? $this->arr_flashdata['input_promo_price'] : '', 'size="20" class="form-control"'); ?>
                    </div>
                </div>
            </div>
