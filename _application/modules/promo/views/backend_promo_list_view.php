...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Judul', name: 'promo_title', width: 300, sortable: true, align: 'left' },
            { display: 'Tanggal Input', name: 'promo_input_datetime', width: 180, sortable: true, align: 'center' },
            { display: 'Aktif', name: 'promo_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Judul', name: 'promo_title', type: 'text', isdefault: true },
            { display: 'Tanggal Input', name: 'promo_input_datetime', type: 'date' },
            { display: 'Status Aktif', name: 'promo_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "promo_id",
        sortorder: "desc",
        usepager: true,
