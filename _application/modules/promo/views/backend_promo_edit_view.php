...
if ($query->num_rows() > 0) {
    ...
    <div class="box">
        <div class="box-title">
            <div class="caption"><i class="icon-reorder"></i>Form Ubah Promo</div>
        </div>
        <div class="box-body form">
            ...
            <?php echo form_hidden('old_image', $row->promo_image); ?>
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_input('title', (isset($this->arr_flashdata['input_title'])) ? $this->arr_flashdata['input_title'] : $row->promo_title, 'size="80" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_textarea('short_content', (isset($this->arr_flashdata['input_short_content'])) ? $this->arr_flashdata['input_short_content'] : $row->promo_short_content, 'cols="80" rows="5" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_textarea_tinymce('promo_content', (isset($this->arr_flashdata['input_promo_content'])) ? $this->arr_flashdata['input_promo_content'] : $row->promo_content, 'PageGenerator'); ?>
                        </div>
                    </div>
                </div>
                
                <div class="form-group">
                <label class="control-label col-md-2">Harga Promo</label>
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        <?php echo form_input('promo_price', (isset($this->arr_flashdata['input_promo_price'])) ? $this->arr_flashdata['input_promo_price'] : $row->promo_price, 'size="20" class="form-control"'); ?>
                    </div>
                </div>
            </div>
