...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Nama Modul', name: 'modules_name', width: 400, sortable: true, align: 'left' },
            { display: 'Link Modul', name: 'modules_links', width: 400, sortable: true, align: 'left' },
            { display: 'Aktif', name: 'modules_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Nama Modul', name: 'modules_name', type: 'text', isdefault: true },
            { display: 'Status Aktif', name: 'modules_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "modules_id",
        sortorder: "desc",
        usepager: true,
