...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Nama Regional', name: 'region_name', width: 300, sortable: true, align: 'left' },
            { display: 'Aktif', name: 'region_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Nama Regional', name: 'region_name', type: 'text', isdefault: true },
            { display: 'Status Aktif', name: 'region_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "region_id",
        sortorder: "desc",
        usepager: true,
