<h2>Tambah Data Regional</h2>
<div class="box">
    <div class="box-title">
        <div class="caption"><i class="icon-reorder"></i>Form Tambah Data Regional</div>
    </div>
    <div class="box-body form">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                <label class="control-label col-md-2">Nama Regional</label>
                <div class="col-md-10">
