<h2>Ubah Data Pembimbing</h2>
<?php
if ($query->num_rows() > 0) {
    $row = $query->row();

    $image = $row->leader_image;
    $directory = _dir_leader;
    ...
    <div class="box">
        <div class="box-title">
            <div class="caption"><i class="icon-reorder"></i>Form Ubah Pembimbing</div>
        </div>
        <div class="box-body form">
            ...
            <?php echo form_hidden('old_image', $row->leader_image); ?>
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_input('name', (isset($this->arr_flashdata['input_name'])) ? $this->arr_flashdata['input_name'] : $row->leader_name, 'size="40" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_input('position', (isset($this->arr_flashdata['input_position'])) ? $this->arr_flashdata['input_position'] : $row->leader_position, 'size="40" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
