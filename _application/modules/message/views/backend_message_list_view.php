<h2>Data Pesan Member</h2>
<div id="response_message" style="display:none;"></div>
<table id="gridview" style="display:none;"></table>
<script>
    $("#gridview").flexigrid({
        url: '<?php echo $this->service_module_url; ?>/get_message_data',
        dataType: 'json',
        colModel: [
            { display: 'Member Pengirim', name: 'sender_network_code', width: 120, sortable: true, align: 'center' },
            { display: 'Nama Pengirim', name: 'sender_member_name', width: 150, sortable: true, align: 'left' },
            { display: 'Member Penerima', name: 'receiver_network_code', width: 120, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Kode Member Pengirim', name: 'sender_network_code', type: 'text', isdefault: true },
            { display: 'Nama Pengirim', name: 'sender_member_name', type: 'text' },
            { display: 'Kode Member Penerima', name: 'receiver_network_code', type: 'text' },
