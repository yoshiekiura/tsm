<h2>Ubah Halaman Depan</h2>
<?php
if ($query->num_rows() > 0) {
    $row = $query->row();
    $image = $row->page_mp_image;
    $directory = _dir_marketing_plan;
    ...
    <div class="box">
        ...
        <div class="box-body form">
            ...
            <?php echo form_hidden('id', $row->page_mp_id); ?>
            <?php echo form_hidden('old_image', $row->page_mp_image); ?>
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_input('title', (isset($this->arr_flashdata['input_title'])) ? $this->arr_flashdata['input_title'] : $row->page_mp_title, 'size="80" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_textarea_tinymce('mp_content', (isset($this->arr_flashdata['input_content'])) ? $this->arr_flashdata['input_content'] : $row->page_mp_content, 'PageGenerator'); ?>
                        </div>
                    </div>
                </div>
