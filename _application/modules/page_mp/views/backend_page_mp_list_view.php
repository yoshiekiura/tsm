<h2>Data Halaman Marketing Plan</h2>
...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Judul', name: 'page_mp_title', width: 400, sortable: false, align: 'left' },
            { display: 'Aktif', name: 'page_mp_is_active', width: 40, sortable: false, align: 'center' },
        ...
        searchitems: [
            { display: 'Judul', name: 'page_mp_title', type: 'text', isdefault: true },
            { display: 'Status Aktif', name: 'page_mp_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "page_mp_id",
        sortorder: "desc",
        usepager: true,
