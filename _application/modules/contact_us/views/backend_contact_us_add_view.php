<h2>Tambah Kontak Kami</h2>
<div class="box">
    <div class="box-title">
        <div class="caption"><i class="icon-reorder"></i>Form Tambah Kontak Kami</div>
    </div>
    <div class="box-body form">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        <?php echo form_textarea_tinymce('contact_content', (isset($this->arr_flashdata['input_content'])) ? $this->arr_flashdata['input_content'] : '', 'PageGenerator'); ?>
                    </div>
                </div>
            </div>
