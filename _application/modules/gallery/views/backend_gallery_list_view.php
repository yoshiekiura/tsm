...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Gambar', name: 'gallery_image', width: 120, sortable: false, align: 'center', datasource: false },
            { display: 'Judul', name: 'gallery_title', width: 250, sortable: true, align: 'left' },
            { display: 'Deskripsi', name: 'gallery_description', width: 400, sortable: true, align: 'left' },
            { display: 'Jumlah Item', name: 'gallery_item_count', width: 80, sortable: true, align: 'center' },
            { display: 'Aktif', name: 'gallery_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Judul', name: 'gallery_title', type: 'text', isdefault: true },
            { display: 'Status Aktif', name: 'gallery_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "gallery_id",
        sortorder: "desc",
        usepager: true,
