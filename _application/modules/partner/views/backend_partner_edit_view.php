...
if ($query->num_rows() > 0) {
    ...
    <div class="box">
        <div class="box-title">
            <div class="caption"><i class="icon-reorder"></i>Form Ubah Partner</div>
        </div>
        <div class="box-body form">
            ...
            <?php echo form_hidden('old_image', $row->partner_image); ?>
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_input('title', (isset($this->arr_flashdata['input_title'])) ? $this->arr_flashdata['input_title'] : $row->partner_title, 'size="80" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_textarea('short_content', (isset($this->arr_flashdata['input_short_content'])) ? $this->arr_flashdata['input_short_content'] : $row->partner_short_content, 'cols="80" rows="5" class="form-control"'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" id="defaultrange">
                            <?php echo form_textarea_tinymce('partner_content', (isset($this->arr_flashdata['input_partner_content'])) ? $this->arr_flashdata['input_partner_content'] : $row->partner_content, 'PageGenerator'); ?>
                        </div>
                    </div>
                </div>
