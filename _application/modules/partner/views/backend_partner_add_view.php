...
<div class="box">
    <div class="box-title">
        <div class="caption"><i class="icon-reorder"></i>Form Tambah Partner</div>
    </div>
    <div class="box-body form">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        <?php echo form_textarea_tinymce('partner_content', (isset($this->arr_flashdata['input_partner_content'])) ? $this->arr_flashdata['input_partner_content'] : '', 'PageGenerator'); ?>
                    </div>
                </div>
            </div>
