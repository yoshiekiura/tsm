...
class frontend_page_home_mainbar_widget extends Widget {
    ...
    public function run() {
        ...
        $data['widget_title'] = 'Welcome';
        $data['query'] = $this->function_lib->get_detail_data('site_page_home', 'page_home_location', 'frontend')->result();
        
        $this->render($widget_themes . 'frontend_page_home_mainbar_widget_view', $data);
    }
}
