...
/**
 * Description of frontend_testimony_mainbar_widget
 *
 * @author Yusuf Rahmanto
 */
class frontend_testimony_mainbar_widget extends Widget {
    ...
    public function run() {
        ...
        $this->render($widget_themes . 'frontend_testimony_mainbar_widget_view', $data);
    }
}
