...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Nama Propinsi', name: 'province_name', width: 200, sortable: true, align: 'left' },
            { display: 'Regional', name: 'region_name', width: 200, sortable: true, align: 'left' },
            { display: 'Aktif', name: 'province_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Nama Propinsi', name: 'province_name', type: 'text', isdefault: true },
            { display: 'Regional', name: 'region_id', type: 'select', option: '<?php echo $region_grid_options; ?>' },
            { display: 'Status Aktif', name: 'province_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
