<h2>Tambah Data Propinsi</h2>
<div class="box">
    <div class="box-title">
        <div class="caption"><i class="icon-reorder"></i>Form Tambah Data Propinsi</div>
    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="input-group" id="defaultrange">
                        <?php echo form_dropdown('region_id', $region_options, (isset($this->arr_flashdata['input_region_id'])) ? $this->arr_flashdata['input_region_id'] : '', 'class="form-control"'); ?>
                    </div>
                </div>
            </div>
