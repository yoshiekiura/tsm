...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Judul', name: 'stockist_title', width: 300, sortable: true, align: 'left' },
            { display: 'Tanggal Input', name: 'stockist_input_datetime', width: 180, sortable: true, align: 'center' },
            { display: 'Aktif', name: 'stockist_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Judul', name: 'stockist_title', type: 'text', isdefault: true },
            { display: 'Tanggal Input', name: 'stockist_input_datetime', type: 'date' },
            { display: 'Status Aktif', name: 'stockist_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
        sortname: "stockist_id",
        sortorder: "desc",
        usepager: true,
        title: '',
        useRp: true,
