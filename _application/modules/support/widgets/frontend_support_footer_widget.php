...
/**
 * Description of frontend_support_footer_widget
 *
 * @author Yusuf Rahmanto
 */
class frontend_support_footer_widget extends Widget {
    ...
    public function run() {
        ...
        $this->render($widget_themes . 'frontend_support_footer_widget_view', $data);
    }
}
