...
<script>
    $("#gridview").flexigrid({
        ...
        dataType: 'json',
        colModel: [
            { display: 'Nama Negara', name: 'country_name', width: 300, sortable: true, align: 'left' },
            { display: 'Bendera', name: 'country_flag', width: 80, sortable: false, align: 'center', datasource: false },
            { display: 'Kode ISO', name: 'country_iso_code', width: 100, sortable: true, align: 'center' },
            { display: 'Kode Telepon', name: 'country_phone_code', width: 100, sortable: true, align: 'center' },
            { display: 'Aktif', name: 'country_is_active', width: 40, sortable: true, align: 'center' },
        ...
        searchitems: [
            { display: 'Nama Negara', name: 'country_name', type: 'text', isdefault: true },
            { display: 'Kode ISO', name: 'country_iso_code', type: 'text' },
            { display: 'Kode Telepon', name: 'country_phone_code', type: 'text' },
            { display: 'Status Aktif', name: 'country_is_active', type: 'select', option: '1:Aktif|0:Tidak Aktif' },
        ],
