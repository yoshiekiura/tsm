<h2>Jaringan Member</h2>
<?php echo form_open($form_action); ?>
    <div style="width: 100%; display: inline-block;">
        <div class="form-group input-group col-md-6" style="padding-left: 0;">
            <?php echo form_hidden('uri_string', uri_string()); ?>
            <?php echo form_input('search_network_code', (isset($this->arr_flashdata['input_search_network_code'])) ? $this->arr_flashdata['input_search_network_code'] : '', 'size="20" placeholder="Masukkan Kode Member" class="form-control"'); ?>
            <span class="input-group-btn">
                <button name="search" type="submit" class="btn btn-primary"><i class="icon-search"></i></button>
            </span>
        </div>
    </div>
<?php echo form_close(); ?>
...
if (!isset($this->arr_flashdata['notfound'])) {
    ?>
    <div class="std">
        <?php echo ($top_network_id > $root_network_id) ? '<a href="' . base_url() . 'backend/member/geneology/' . $arr_data[1]['upline_network_code'] . '">&laquo; Lihat Jaringan Sebelumnya</a>' : ''; ?>
                ...
                $(this).qtip({
                    content: {
                        text: function(event, api) {
                            $.ajax({
                                url: '<?php echo base_url(); ?>backend/member/get_member_info/' + network_code
                            })
