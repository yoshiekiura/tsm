...
<script>
    $("#gridview").flexigrid({
        ...
        colModel: [
            ...
            { display: 'Password', name: 'edit_password', width: 70, sortable: false, align: 'center', datasource: false },
            { display: 'Login', name: 'autologin', width: 50, sortable: false, align: 'center', datasource: false },
        ],
        buttons: [
