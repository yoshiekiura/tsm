...
<form target="_blank" id="form_export" method="post" action="export_gen_sponsor_data">
...
<script>
    $("#gridview").flexigrid({
        url: 'get_gen_sponsor_data',
        dataType: 'json',
        colModel: [
            { display: 'Level', name: 'netgrow_gen_sponsor_level', width: 50, sortable: true, align: 'center' },
            ...
            { display: 'Tanggal', name: 'netgrow_gen_sponsor_date', width: 120, sortable: true, align: 'center' },
        ],
        buttons_right: [
            { display: 'Export Excel', name: 'excel', bclass: 'excel', onpress: export_data },
        ],
        searchitems: [
            { display: 'Level', name: 'netgrow_gen_sponsor_level', type: 'text', isdefault: true },
            ...
            { display: 'Tanggal', name: 'netgrow_gen_sponsor_date', type: 'date' },
        ],
        sortname: "netgrow_gen_sponsor_id",
        sortorder: "desc",
        usepager: true,
        title: '',
        useRp: true,
