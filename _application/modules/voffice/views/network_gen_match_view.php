<h2>History Generasi Pasangan</h2>
<table id="gridview" style="display:none;"></table>

<form target="_blank" id="form_export" method="post" action="export_gen_match_data">
...
<script>
    $("#gridview").flexigrid({
        url: 'get_gen_match_data',
        dataType: 'json',
        colModel: [
            { display: 'Level', name: 'netgrow_gen_match_level', width: 50, sortable: true, align: 'center' },
            ...
            { display: 'Tanggal', name: 'netgrow_gen_match_date', width: 120, sortable: true, align: 'center' },
        ],
        buttons_right: [
            { display: 'Export Excel', name: 'excel', bclass: 'excel', onpress: export_data },
        ],
        searchitems: [
            { display: 'Level', name: 'netgrow_gen_match_level', type: 'text', isdefault: true },
            ...
            { display: 'Tanggal', name: 'netgrow_gen_match_date', type: 'date' },
        ],
        sortname: "netgrow_gen_match_id",
        sortorder: "desc",
        usepager: true,
        title: '',
        useRp: true,
