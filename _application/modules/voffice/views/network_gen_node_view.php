<h2>History Generasi Titik</h2>
<table id="gridview" style="display:none;"></table>

<form target="_blank" id="form_export" method="post" action="export_gen_node_data">
...
<script>
    $("#gridview").flexigrid({
        url: 'get_gen_node_data',
        dataType: 'json',
        colModel: [
            { display: 'Level', name: 'netgrow_gen_node_level', width: 50, sortable: true, align: 'center' },
            ...
            { display: 'Tanggal', name: 'netgrow_gen_node_date', width: 120, sortable: true, align: 'center' },
        ],
        buttons_right: [
            { display: 'Export Excel', name: 'excel', bclass: 'excel', onpress: export_data },
        ],
        searchitems: [
            { display: 'Level', name: 'netgrow_gen_node_level', type: 'text', isdefault: true },
            ...
            { display: 'Tanggal', name: 'netgrow_gen_node_date', type: 'date' },
        ],
        sortname: "netgrow_gen_node_id",
        sortorder: "desc",
        usepager: true,
        title: '',
        useRp: true,
