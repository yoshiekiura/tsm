<h2>History Upline Sponsor</h2>
<table id="gridview" style="display:none;"></table>

<form target="_blank" id="form_export" method="post" action="export_upline_sponsor_data">
...
<script>
    $("#gridview").flexigrid({
        ...
        colModel: [
            ...
            { display: 'Tanggal', name: 'netgrow_upline_sponsor_date', width: 120, sortable: true, align: 'center' },
        ],
        buttons_right: [
            { display: 'Export Excel', name: 'excel', bclass: 'excel', onpress: export_data },
        ],
        searchitems: [
            { display: 'Kode Member', name: 'downline_network_code', type: 'text', isdefault: true },
            ...
            { display: 'Tanggal', name: 'netgrow_upline_sponsor_date', type: 'date' },
        ],
        sortname: "netgrow_upline_sponsor_id",
        sortorder: "desc",
        usepager: true,
        title: '',
        useRp: true,
