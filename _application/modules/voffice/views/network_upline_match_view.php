<h2>History Upline Pasangan</h2>
<table id="gridview" style="display:none;"></table>

<form target="_blank" id="form_export" method="post" action="export_upline_match_data">
...
<script>
    $("#gridview").flexigrid({
        ...
        colModel: [
            ...
            { display: 'Tanggal', name: 'netgrow_upline_match_date', width: 120, sortable: true, align: 'center' },
        ],
        buttons_right: [
        ...
        searchitems: [
            ...
            { display: 'Tanggal', name: 'netgrow_upline_match_date', type: 'date' },
        ],
        sortname: "netgrow_upline_match_id",
        sortorder: "desc",
        usepager: true,
        title: '',
        useRp: true,
