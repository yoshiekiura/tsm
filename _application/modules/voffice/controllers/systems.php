...
class Systems extends Member_Controller {
    ...
    function act_profile() {
        ...
        $this->form_validation->set_rules('account_username', '<b>Username</b>', 'required|min_length[5]|max_length[15]|alpha_dash|callback_username_check[' . $this->session->userdata('network_id') . ']');
