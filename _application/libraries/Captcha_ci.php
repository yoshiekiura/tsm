...
/**
  ...
  $captcha = $this->captcha_ci->get_captcha_ci_image($configs);
...
class Captcha_ci {
    ...
    var $style = 'border:0;'; // style css

    // Initialization for Captcha Image

    function get_captcha_ci_image($override = array()) {
        ...
        $img_markup = '<img src="' . $this->img_url . $img_name . '" width=" ' . $this->img_width
                . '" height="' . $this->img_height . '" style="' . $this->style . '" alt=" " />';
