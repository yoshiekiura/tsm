                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                            ...
                            <div class="navbar-brand">
                                <a href="<?php echo base_url() ?>" class="logo" alt="logo"><img src="<?php echo base_url(_dir_site_config . $this->site_configuration['logo']); ?>" alt="<?php echo $this->site_configuration['title']; ?>"></a>
                            </div>
                        </div>
