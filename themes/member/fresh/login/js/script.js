...
$(document).ready(function() {
    ...
    // counter = $('#row-serial .items').length + 1;

    var newRow = $("<div class='form-group row' id='row-serial'>");
    var cols = "";
    cols += '<div class="items">';
    cols += '<div class="col-md-6">';
    cols += '<label for="serial' + counter + '">Nomor Serial ' + counter + ' <span class="required">*</span></label>';
    cols += '<input type="text" class="form-control" id="reg_serial[' + counter + ']" name = "reg_serial[' + counter + ']" placeholder="nomor serial ...">';
    cols += '</div>';

    cols += '<div class="col-md-6">';
    cols += '<label for="pin' + counter + '">PIN ' + counter + ' <span class="required">*</span></label>';
    cols += '<input type="text" class="form-control" id="reg_pin[' + counter + ']" name = "reg_pin[' + counter + ']" placeholder="pin ...">';
    cols += '</div>';
    cols += '</div>';

    $("#btnpaket1").on("click", function() {
        $('#row-serial .items').remove();
        $("#paket1").attr('checked', true);
        ...
        if (counter == 1) {
            ...
            //alert('Silahkan lengkapi data nomor serial dan pin untuk 1 paket serial');
        }
    });

    $("#btnpaket3").on("click", function() {
        $('#row-serial .items').remove();
        $("#paket3").attr('checked', true);
        var i = 1;
        counter = i;
        ...
        for (i = 1; i <= 3; i++) {
            ...
            cols += '<div class="col-md-6">';
            cols += '<label for="serial' + counter + '">Nomor Serial ' + counter + ' <span class="required">*</span></label>';
//            cols += '<input type="text" class="form-control" id="serial'+ counter +'" placeholder="nomor serial ...">';
            cols += '<input type="text" class="form-control" id="reg_serial[' + counter + ']" name = "reg_serial[' + counter + ']" placeholder="nomor serial ...">';
            cols += '</div>';

            cols += '<div class="col-md-6">';
            cols += '<label for="pin' + counter + '">PIN ' + counter + ' <span class="required">*</span></label>';
//            cols += '<input type="text" class="form-control" id="pin'+ counter +'" placeholder="pin ...">';
            cols += '<input type="text" class="form-control" id="reg_pin[' + counter + ']" name = "reg_pin[' + counter + ']" placeholder="pin ...">';
            cols += '</div>';
            cols += '</div>';
    ...
    $("#btnpaket7").on("click", function() {
        $('#row-serial .items').remove();
        $("#paket7").attr('checked', true);
        var i = 1;
        counter = i;
...
//            cols += '<input type="text" class="form-control" id="pin'+ counter +'" placeholder="pin ...">';
    ...
    $("#btnpaket15").on("click", function() {
        $('#row-serial .items').remove();
        $("#paket15").attr('checked', true);
        var i = 1;
        counter = i;
